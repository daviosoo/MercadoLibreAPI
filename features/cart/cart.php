...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    else
    {
        ...
        try
        {
            $query= "INSERT INTO cart (id_producto, nombre_producto, precio_producto, url_producto, cantidad, identification_usuario) VALUES ($idProducto, '$nombreProducto', $precio, '$urlProducto', $cantidadProducto, $identificacionUsuario)";
